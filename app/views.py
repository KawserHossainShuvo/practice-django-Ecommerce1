...
class ProductView(View):
    def get(self, request):
        ...
        return render(request, 'app/home.html', {'topwears':topwears, 'bottomwears':bottomwears, 'totalitem':totalitem, 'mobiles':mobiles})
...
def mobile(request, data=None):
    ...
    if data==None:
        ...
        mobiles = Product.objects.filter(category='M').filter(discounted_price__lte=3000)
    elif data=='above':
        mobiles = Product.objects.filter(category='M').filter(discounted_price__gt=3000)
